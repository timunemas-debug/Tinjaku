          ...
          >
            ...
            <div className="mb-5">
              ...
              <textarea
                ...
                rows={3}
                className="w-full border border-black/[0.12] rounded-xl px-4 py-3.5 text-sm outline-none resize-none focus:border-[#FFC800] focus:ring-2 focus:ring-[#FFC800]/20"
                required
              />
            ...
            <div className="flex justify-end gap-3">
              ...
              <button
                type="submit"
                disabled={saving}
                className="inline-flex items-center gap-2 bg-[#FFC800] text-[#111116] px-5 py-3 rounded-xl text-sm font-bold hover:brightness-95 disabled:opacity-50 transition"
              >
                ...
                <div className="flex items-start justify-between gap-5">
                  ...
                  <div className="flex items-center gap-1 shrink-0">
                    ...
                    <button
                      ...
                      className="w-9 h-9 rounded-lg flex items-center justify-center text-black/35 hover:text-black hover:bg-black/5 transition"
                      title="Edit alamat"
                    >
                      <FiEdit2 size={16} />
                    </button>
